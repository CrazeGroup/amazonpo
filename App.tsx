    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 pb-20 flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 flex-grow">
        ...
        {processedData.length > 0 && (
          <div className="bg-white rounded-lg shadow border border-gray-200 overflow-hidden animate-fade-in-up mb-12">
            
            {/* Header */}
            <div className="px-4 py-2 border-b border-gray-200 flex flex-col md:flex-row justify-between items-center bg-gray-50 gap-2">
              <div className="flex items-center gap-3">
              ...
              <div className="flex bg-white rounded border border-gray-200 overflow-hidden">
                <button
                  ...
                  className={`px-4 py-1.5 text-xs font-bold transition-colors flex items-center gap-1
                    ${activeTab === 'details' 
              ...
              <div className="flex gap-2">
                ...
                <div className="relative" ref={exportMenuRef}>
                    <button
                        ...
                        className="flex items-center gap-1 px-3 py-1 bg-amazon-light text-white rounded hover:bg-gray-700 transition-colors font-medium text-xs shadow-sm"
                    >
                    ...
                    {isExportMenuOpen && (
                        <div className="absolute right-0 mt-1 w-40 bg-white rounded-md shadow-xl border border-gray-200 z-50 overflow-hidden animate-fade-in">
                             <div className="py-1">
                                <button onClick={() => handleExportConfirmation('DE')} className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-blue-50 hover:text-amazon-blue">Germany (DE)</button>
                                <button onClick={() => handleExportConfirmation('UK')} className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-blue-50 hover:text-amazon-blue">United Kingdom (UK)</button>
                                <button onClick={() => handleExportConfirmation('EU')} className="block w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-blue-50 hover:text-amazon-blue">EU (ES/IT/FR)</button>
                             </div>
                        </div>
                    )}
                </div>
                ...
                <button
                    ...
                    className="flex items-center gap-1 px-3 py-1 bg-green-600 text-white rounded hover:bg-green-700 transition-colors font-medium text-xs shadow-sm"
                >
                    Export Full Excel
                </button>
              </div>
